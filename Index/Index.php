                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="login">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-info" data-dismiss="modal" src="../login.php">Login</button>
                                                        </div>
                 </form>
                                        ...
                                        <div class="nav-link">
                                            ...
                                            <form class="dropdown-menu p-3 dropdown-menu-right mr-5 ">
                                                <div class="form-group">
                                                    <a href="../DataRegister/RegisterPeople/registerPeople.php" class="btn btn-info" role="button">Dependentes</a>
                                                </div>
                                                <div class="form-group">
                                                    <a href="../DataRegister/RegisterPeople/registerPeople.php" class="btn btn-secondary" role="button">Instituição</a>
